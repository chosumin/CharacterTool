...
public:
	...
	static void Render(const sMesh<T>& mesh, D3D_PRIMITIVE_TOPOLOGY type = D3D11_PRIMITIVE_TOPOLOGY_TRIANGLELIST)
	{
		Render(mesh.VertexBuffer, mesh.IndexBuffer, mesh.Indices.size(), type);
	}
};