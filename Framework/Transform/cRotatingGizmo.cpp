...
#include "./Collider/cSphereLineCollider.h"
...
cRotatingGizmo::cRotatingGizmo(weak_ptr<sGlobalVariable> global)
	:cBasicGizmo(global)
{
	_axises.emplace_back(make_unique<cSphereLineCollider>(_length, D3DXCOLOR{ 1,0,0,1 }, D3DXVECTOR3{ 1,0,0 }, D3DXVECTOR3{ 0,-rate,-rate }, D3DXVECTOR3{ _length,rate,rate }));

	_axises.emplace_back(make_unique<cSphereLineCollider>(_length, D3DXCOLOR{ 0,1,0,1 }, D3DXVECTOR3{ 0,1,0 }, D3DXVECTOR3{ -rate,0,-rate }, D3DXVECTOR3{ rate,_length,rate }));

	_axises.emplace_back(make_unique<cSphereLineCollider>(_length, D3DXCOLOR{ 0,0,1,1 }, D3DXVECTOR3{ 0,0,-1 }, D3DXVECTOR3{ -rate,-rate,-_length }, D3DXVECTOR3{ rate,rate,0 }));
}
