...
#include "./Collider/cBoxLineCollider.h"
...
{
	auto len = rate * 4.0f;
	_axises.emplace_back(make_unique<cBoxLineCollider>(_length, D3DXCOLOR{ 1,0,0,1 }, D3DXVECTOR3{ 1,0,0 }, D3DXVECTOR3{ 0,-len,-len }, D3DXVECTOR3{ _length,len,len }));

	_axises.emplace_back(make_unique<cBoxLineCollider>(_length, D3DXCOLOR{ 0,1,0,1 }, D3DXVECTOR3{ 0,1,0 }, D3DXVECTOR3{ -len,0,-len }, D3DXVECTOR3{ len,_length,len }));

	_axises.emplace_back(make_unique<cBoxLineCollider>(_length, D3DXCOLOR{ 0,0,1,1 }, D3DXVECTOR3{ 0,0,1 }, D3DXVECTOR3{ -len,-len,-_length }, D3DXVECTOR3{ len,len,0 }));
}
